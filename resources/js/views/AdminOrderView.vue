  ...
  <div class="min-h-screen bg-white font-system">
    ...
    <main class="max-w-7xl mx-auto px-8 py-12">
      ...
      <div v-if="loading" class="space-y-4">
        <div v-for="i in 5" :key="i" class="bg-gray-50 rounded-lg h-20 animate-pulse"></div>
      </div>
      ...
      <!-- Empty State -->
      <div v-else-if="filteredOrders.length === 0" class="bg-gray-50 border border-gray-200 rounded-lg p-12 text-center">
        ...
        <table class="w-full border-collapse">
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-4 px-4">
                <span :class="['px-3 py-1 rounded-full text-xs font-medium', statusColors[order.status] || 'bg-gray-100']">
                  {{ order.status }}
                </span>
              </td>
    ...
    <transition name="fade">
      <div v-if="selectedOrder" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-8 space-y-6">
            ...
            <div>
              ...
              <div class="space-y-2 text-sm text-gray-600">
                ...
                <p>
                  ...
                  <span :class="['ml-2 px-2 py-1 rounded text-xs font-medium', statusColors[selectedOrder.status]]">
          ...
          <div>
            ...
            <div class="bg-gray-50 rounded-lg overflow-hidden">
              <table class="w-full text-sm">
                ...
                <tbody>
                  <tr v-for="item in selectedOrder.items" :key="item.id" class="border-b border-gray-200 last:border-0">
          ...
          <!-- Status Update -->
          <div v-if="selectedOrder.status !== 'cancelled'" class="bg-gray-50 rounded-lg p-4">
            <label class="block text-sm font-medium text-gray-900 mb-2">Cập nhật trạng thái</label>
            <div class="flex gap-2 flex-wrap">
              <button
                v-for="status in ['confirmed', 'shipped', 'delivered', 'cancelled']"
                :key="status"
