          ...
          <Transition name="slide">
            ...
            >
              ...
              <div class="p-4 space-y-6 overflow-y-auto h-full">
                <!-- Quick Links -->
                <div class="space-y-1">
                    <p class="px-3 text-[11px] font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-widest mb-2">Menu</p>
                  <nav class="space-y-1">
                    <router-link
                      to="/browse"
                ...
                <!-- Categories -->
                <div class="space-y-1">
                    <p class="px-3 text-[11px] font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-widest mb-2">Danh mục</p>
                  <nav class="space-y-1">
                    <router-link
